...
<% if( session.getAttribute("ConnectedUser") != null){ %>
    ...
    <nav class="navbar">
      <div class="brand-title"> <a href="<%=request.getContextPath()%>/AccueilConnecte"> Eni-Enchères </a></div>
      ...
      <%Utilisateur connectedUser = (Utilisateur) session.getAttribute("ConnectedUser"); %>
          <ul>
              ...
              <li><a href="AccueilPasConnecte">Deconnexion  <i class="fas fa-sign-in-alt"></i></a></li>
          </ul>
      </div>
    </nav>
